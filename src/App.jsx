...
export default function MetallFactureSite() {
  ...
  const projects = [
    ...
    },
    {
      ...
      image:
        '/images/npo.jpg',
        description: 'Разработка чертежей КМД, производство и поставка 37 тонн металлоконструкций здания склада готовой продукции.'
    },
    {
      ...
      image:
        '/images/monplez.jpg',
        description: 'Разработка чертежей КМД, производство, поставка и монтаж 42 тонн металлоконструкций здания Зимнего сада.'
    }
  ]
